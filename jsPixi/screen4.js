...
function play(){
	...
	var Look1 = function(){
		...
		Sprites[2].interactive = true;
		Sprites[2].buttonMode = true;

		Sprites[3].interactive = true;
		Sprites[3].buttonMode = true;

		Sprites[4].interactive = true;
		Sprites[4].buttonMode = true;

		Sprites[5].interactive = true;
		Sprites[5].buttonMode = true;

		var s_task1 = function() {
			 objs[1].setRecv(objs[2]);
			 console.log(objs[2]);
		}

		var s_task2 = function() {
			 objs[1].setRecv(objs[3]);
			 console.log(objs[3]);
		}

		var s_task3 = function() {
			 objs[1].setRecv(objs[4]);
			 console.log(objs[4]);
		}

		var s_task4 = function() {
			 objs[1].setRecv(objs[5]);
			 console.log(objs[5]);
		}
		
		Sprites[2].on("click", s_task1);
		Sprites[3].on("click", s_task2);
		Sprites[4].on("click", s_task3);
		Sprites[5].on("click", s_task4);
